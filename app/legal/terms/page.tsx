...
export const metadata: Metadata = {
  ...
  description: "VitalPath Terms of Service governing use of our telehealth weight management platform, medication programs, and related services.",
};
    ...
    <section className="py-16">
        <SectionShell className="max-w-3xl">
          ...
          <div className="mt-6 rounded-xl border border-navy-100 bg-linen/50 p-5 text-sm text-graphite-600">
            <strong>Summary:</strong> VitalPath is a technology platform that connects patients with independent, licensed healthcare providers. We do not practice medicine. All prescribing decisions are made by your provider. Compounded medications are not FDA-approved. Please read this agreement carefully before using our services.
          </div>
          ...
          <div className="mt-10 space-y-10 text-sm leading-relaxed text-graphite-600">
            ...
            <section>
              ...
              <p>To use VitalPath you must:</p>
              <ul className="mt-2 ml-4 list-disc space-y-1">
                <li>Be at least 18 years of age. VitalPath does not knowingly provide services to minors. If you are under 18, do not use this platform.</li>
                <li>Reside in a U.S. state or territory where VitalPath currently operates. See our <Link href="/states" className="text-teal underline hover:text-teal/80">State Availability</Link> page for a current list.</li>
            ...
            <section>
              ...
              <p>VitalPath is a health technology company, not a medical practice. We provide a platform that:</p>
              <ul className="mt-2 ml-4 list-disc space-y-1">
              ...
              <p className="mt-2"><strong>VitalPath does not practice medicine, dentistry, pharmacy, or any other licensed healthcare profession.</strong> All clinical decisions — including diagnosis, treatment planning, medication selection, dosing, titration schedules, and termination of treatment — are made exclusively by your assigned licensed provider in the exercise of their independent professional judgment. VitalPath does not direct, control, or influence provider clinical decisions.</p>
              <p className="mt-2">Healthcare providers available through VitalPath may be employed by or contracted with independent medical groups, professional corporations, or practice management organizations that are separate legal entities from VitalPath.</p>
            </section>

            {/* 4 */}
            <section>
              <h2 className="text-lg font-bold text-navy">4. Telehealth Consent and Limitations</h2>
              <p><strong>Consent to Telehealth:</strong> By using VitalPath, you consent to the delivery of healthcare services via telehealth, including evaluation, consultation, and follow-up through electronic communications, messaging, video, and/or asynchronous review of your submitted health information.</p>
              ...
              <p className="mt-2"><strong>State Telehealth Laws:</strong> Telehealth regulations vary by jurisdiction. VitalPath complies with applicable telehealth laws in all states where we operate. Certain states require specific consent disclosures, restrictions on prescribing, or in-person visit requirements prior to telehealth services. Your provider and VitalPath will comply with all applicable state requirements.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">For non-emergency adverse effects or medication concerns, contact your VitalPath provider through the secure messaging system or call our care line at (888) 509-2745 during business hours.</p>
            </section>
            ...
            <section>
              ...
              <p><strong>Subscription Plans:</strong> VitalPath offers recurring membership plans. By subscribing, you authorize VitalPath to charge your payment method at the applicable rate on a recurring basis (monthly, quarterly, or annually depending on your plan).</p>
              ...
              <p className="mt-2"><strong>Refunds:</strong> Membership fees are generally non-refundable after the billing date. If you are not satisfied with your initial membership, please contact care@vitalpath.com within 30 days of your first charge to discuss options. Medication costs are separate from membership fees. Refunds for medication already dispensed and shipped are not available due to pharmacy regulations, but we will work with you on a case-by-case basis if medication was damaged, incorrect, or not received.</p>
              <p className="mt-2"><strong>Price Changes:</strong> VitalPath reserves the right to change subscription pricing with 30 days&rsquo; advance notice. Continued use of the service after a price change constitutes acceptance of the new price.</p>
              <p className="mt-2"><strong>No Insurance Billing:</strong> VitalPath does not bill health insurance, Medicare, or Medicaid for its membership services or medications. All payments are out-of-pocket. VitalPath is not responsible for any reimbursement issues with your insurer. We can provide receipts that you may submit independently for reimbursement; however, reimbursement is not guaranteed and is the sole responsibility of the member.</p>
            </section>

            {/* 10 */}
            <section>
              <h2 className="text-lg font-bold text-navy">10. Privacy, HIPAA, and Health Information</h2>
              <p>Your health information is protected under the Health Insurance Portability and Accountability Act (HIPAA) and applicable state privacy laws. VitalPath operates as a Covered Entity or Business Associate, as applicable, and maintains HIPAA-compliant policies and technical safeguards.</p>
              ...
              <p className="mt-2"><strong>Electronic Communications:</strong> By creating an account and providing your phone number or email address, you consent to receive electronic communications from VitalPath, including appointment reminders, treatment updates, and care-related notifications. These communications are necessary for the provision of healthcare services and may not be fully opted out of while you remain an active patient. Marketing communications may be opted out of at any time.</p>
              <p className="mt-2"><strong>SMS/Text Messages:</strong> By providing your mobile number, you consent to receive text messages from VitalPath for service-related communications. Standard message and data rates may apply. Reply STOP to opt out of marketing texts. Opting out of clinical or safety-related texts may impact your care.</p>
            </section>

            {/* 11 */}
            <section>
              <h2 className="text-lg font-bold text-navy">11. Intellectual Property</h2>
              <p>All content, features, software, trademarks, and functionality on the VitalPath platform are owned by VitalPath Health, Inc. or its licensors and are protected by U.S. and international intellectual property laws. You may not reproduce, distribute, modify, create derivative works, publicly display, or commercially exploit any content without express prior written consent from VitalPath.</p>
              <p className="mt-2">You grant VitalPath a limited, non-exclusive, royalty-free license to use any content you submit (such as progress photos, feedback, or testimonials) solely to provide and improve our services, with your separate consent for any public use.</p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                ...
                <li>Harass, threaten, or abuse VitalPath staff, providers, or other users;</li>
            ...
            <section>
              ...
              <p className="mt-2">VitalPath does not guarantee specific health outcomes, weight loss results, or the effectiveness of any prescribed treatment for any individual. Individual results vary based on many factors including adherence, physiology, and lifestyle.</p>
            </section>
            ...
            <section>
              ...
              <p>You agree to indemnify, defend, and hold harmless VitalPath and its officers, directors, employees, and agents from and against any claims, damages, losses, liabilities, and expenses (including reasonable attorneys&rsquo; fees) arising out of or relating to: (a) your use of the services; (b) your violation of these Terms; (c) your provision of false or inaccurate health information; or (d) your violation of any third-party rights.</p>
            </section>

            {/* 16 */}
            <section>
              <h2 className="text-lg font-bold text-navy">16. Termination</h2>
              <p>VitalPath may suspend or terminate your account and access to services at any time, with or without notice, for any reason, including but not limited to violation of these Terms, fraudulent conduct, or if required by law or a healthcare provider.</p>
            ...
            <section>
              ...
              <p><strong>Informal Resolution:</strong> Before initiating any formal proceedings, you agree to contact VitalPath at care@vitalpath.com and allow a 30-day period for good-faith informal resolution.</p>
            ...
            <section>
              ...
              <p className="mt-2"><strong>Texas Residents:</strong> In compliance with Texas Occupations Code Chapter 111, Texas Medical Board rules, and the Texas standard of care, providers serving Texas patients must establish a proper provider-patient relationship before prescribing. VitalPath&rsquo;s intake and evaluation process is designed to satisfy this requirement.</p>
              <p className="mt-2"><strong>All States:</strong> You are encouraged to familiarize yourself with your state&rsquo;s telehealth and compounding pharmacy regulations. VitalPath&rsquo;s compliance team monitors regulatory requirements and updates service delivery accordingly.</p>
            </section>

            {/* 19 */}
            <section>
              <h2 className="text-lg font-bold text-navy">19. Accessibility</h2>
              <p>VitalPath is committed to making our platform accessible to people with disabilities in compliance with the Americans with Disabilities Act (ADA) and Web Content Accessibility Guidelines (WCAG) 2.1 Level AA. If you experience accessibility barriers, please contact us at care@vitalpath.com or (888) 509-2745 so we can assist and improve.</p>
            </section>

            {/* 20 */}
            <section>
              <h2 className="text-lg font-bold text-navy">20. Changes to These Terms</h2>
              <p>VitalPath reserves the right to modify these Terms at any time. We will provide notice of material changes by email and/or prominent notice on our platform at least 14 days before the changes take effect. Your continued use of the services after the effective date constitutes acceptance of the revised Terms.</p>
            </section>
            ...
            <section>
              ...
              <div className="mt-2 rounded-xl border border-navy-100 bg-linen/40 p-4 text-sm">
                <p className="font-semibold text-navy">VitalPath Health, Inc.</p>
                <p>1209 Orange St, Wilmington, DE 19801</p>
                <p className="mt-2">General inquiries: <a href="mailto:care@vitalpath.com" className="text-teal underline hover:text-teal/80">care@vitalpath.com</a></p>
                <p>Legal/Privacy: <a href="mailto:privacy@vitalpath.com" className="text-teal underline hover:text-teal/80">privacy@vitalpath.com</a></p>
