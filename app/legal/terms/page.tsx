        ...
        <SectionShell className="max-w-3xl">
          ...
          <div className="mt-10 space-y-10 text-sm leading-relaxed text-graphite-600">
            ...
            <section>
              ...
              <p>THE NATURE'S JOURNEY PLATFORM AND SERVICES ARE PROVIDED &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo; WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. NATURE'S JOURNEY DOES NOT WARRANT THAT THE SERVICES WILL BE UNINTERRUPTED, ERROR-FREE, OR COMPLETELY SECURE.</p>
            ...
            <section>
              ...
              <p>TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, NATURE'S JOURNEY, ITS OFFICERS, DIRECTORS, EMPLOYEES, AFFILIATES, AND LICENSORS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES, INCLUDING LOSS OF PROFITS, DATA, GOODWILL, OR HEALTH OUTCOMES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE SERVICES.</p>
              <p className="mt-2">NATURE'S JOURNEY&rsquo;S TOTAL CUMULATIVE LIABILITY FOR ANY CLAIM ARISING OUT OF THESE TERMS OR THE SERVICES SHALL NOT EXCEED THE TOTAL AMOUNT YOU PAID TO NATURE'S JOURNEY IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.</p>
