...
export const metadata: Metadata = {
  ...
  description: "VitalPath HIPAA Notice of Privacy Practices — how your Protected Health Information is used, disclosed, and protected.",
};
        ...
        <SectionShell className="max-w-3xl">
          ...
          <div className="mt-10 space-y-10 text-sm leading-relaxed text-graphite-600">
            ...
            <section>
              ...
              <p>This Notice applies to VitalPath Health, Inc. and the healthcare providers, nurses, care coordinators, and other workforce members who access your Protected Health Information (PHI) in connection with services provided through the VitalPath platform. It also applies to business associates who handle PHI on our behalf under written Business Associate Agreements (BAAs).</p>
              <p className="mt-2">VitalPath operates as a Covered Entity under the Health Insurance Portability and Accountability Act of 1996 (HIPAA), as amended by the Health Information Technology for Economic and Clinical Health (HITECH) Act, and the regulations promulgated thereunder (45 CFR Parts 160 and 164).</p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div>
                  <p><strong>Payment:</strong> We use PHI for billing, payment processing, and related activities, including verifying payment methods and processing subscription charges. Note that VitalPath does not bill third-party insurers for its membership services.</p>
                </div>
                <div>
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li>
                  <p><strong>Right to Access (Right of Access):</strong> You have the right to inspect and obtain a copy of your PHI maintained by VitalPath in a designated record set. Requests must be submitted in writing to privacy@vitalpath.com. We will respond within 30 days (or 60 days with a written extension notice). We may charge a reasonable cost-based fee for copies. We will provide access in the format you request if readily producible, including electronic format.</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Right to Opt Out of Fundraising:</strong> VitalPath does not currently conduct fundraising. If we do in the future, you will have the right to opt out of receiving fundraising communications.</p>
                </li>
                <li>
              ...
              <p className="mt-4">To exercise any of these rights, contact our Privacy Officer at privacy@vitalpath.com or (888) 509-2745.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-navy">5. Safeguards — Administrative, Technical, and Physical</h2>
              <p>VitalPath maintains a comprehensive HIPAA Security Program in compliance with 45 CFR Part 164, Subpart C (Security Rule). Our safeguards include:</p>
            ...
            <section>
              ...
              <p>VitalPath follows the HIPAA Breach Notification Rule (45 CFR Part 164, Subpart D). A breach is an impermissible use or disclosure of unsecured PHI that compromises the security or privacy of the PHI, unless VitalPath can demonstrate a low probability that PHI was compromised based on a four-factor risk assessment.</p>
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                ...
                <li>What VitalPath is doing to investigate and mitigate harm;</li>
            ...
            <section>
              ...
              <p>VitalPath retains PHI for the following minimum periods, or longer if required by applicable law:</p>
            ...
            <section>
              ...
              <p>VitalPath may de-identify PHI in accordance with 45 CFR § 164.514 using either the Safe Harbor method (removing 18 specified identifiers) or Expert Determination method (statistical confirmation of de-identification). De-identified data is no longer subject to HIPAA and may be used for research, product improvement, and aggregate analytics without restriction.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-navy">9. Business Associate Agreements</h2>
              <p>All third parties that access PHI on VitalPath&rsquo;s behalf are required to execute a Business Associate Agreement (BAA) that obligates them to: (a) use PHI only for permitted purposes; (b) implement appropriate safeguards; (c) report breaches; (d) ensure their subcontractors comply; and (e) return or destroy PHI upon termination of the relationship.</p>
              <p className="mt-2">Categories of business associates include: cloud infrastructure providers, pharmacy management systems, telehealth technology providers, secure messaging platforms, and data analytics services. VitalPath&rsquo;s BAA template is available upon written request.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-navy">10. Complaints and Enforcement</h2>
              <p>If you believe VitalPath has violated your privacy rights, you may file a complaint:</p>
              <div className="mt-3 space-y-3">
                <div className="rounded-xl border border-navy-100 bg-linen/40 p-4">
                  <p className="font-semibold text-navy">VitalPath Privacy Officer</p>
                  <p>Email: <a href="mailto:privacy@vitalpath.com" className="text-teal underline hover:text-teal/80">privacy@vitalpath.com</a></p>
            ...
            <section>
              ...
              <p>VitalPath reserves the right to change this Notice and to make the revised Notice effective for PHI we already maintain. We will post the current Notice prominently on our website and provide a copy upon request. Material changes will be communicated to active patients via email at least 30 days before the effective date.</p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                ...
                <li><Link href="/legal/terms" className="text-teal underline hover:text-teal/80">Terms of Service</Link> — Your rights and obligations as a VitalPath member</li>
                <li><Link href="/legal/baa" className="text-teal underline hover:text-teal/80">Business Associate Agreement</Link> — For covered entities that work with VitalPath</li>
              </ul>
            </section>
