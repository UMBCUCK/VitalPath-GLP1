...
export const metadata: Metadata = {
  ...
  description: "Nature's Journey Business Associate Agreement (BAA) policy for HIPAA-compliant vendor relationships and protected health information handling.",
};
      ...
      <SectionShell className="max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-graphite-600">
          <section>
            ...
            <p>A Business Associate Agreement (BAA) is a legally binding contract required under the Health Insurance Portability and Accountability Act (HIPAA) between a covered entity (such as Nature's Journey) and a business associate — any third-party vendor or service provider that creates, receives, maintains, or transmits Protected Health Information (PHI) on behalf of the covered entity.</p>
          ...
          <section>
            ...
            <p className="mt-2">For patients, this means that your health information is protected not only by Nature's Journey directly, but also by every vendor that touches your data as part of delivering your care.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy">Nature's Journey&apos;s BAA Policy</h2>
            <p>Nature's Journey requires all vendors and service providers that handle, access, store, or transmit Protected Health Information to execute a Business Associate Agreement before any PHI is shared. No exceptions are made to this policy.</p>
          ...
          <section>
            ...
            <p>Nature's Journey maintains executed BAAs with all categories of vendors that handle PHI in the course of delivering our services, including:</p>
            <ul className="mt-2 space-y-2">
          ...
          <section>
            ...
            <p>If you are a vendor or service provider seeking to work with Nature's Journey and will handle Protected Health Information, you may request a copy of our BAA template for review. Please contact our compliance team to initiate the BAA process:</p>
            <p className="mt-2">Nature's Journey Compliance Team<br />Email: compliance@naturesjourneyhealth.com<br />Phone: (888) 509-2745</p>
            <p className="mt-2">All BAA requests are reviewed by our compliance and legal teams. Nature's Journey reserves the right to require additional security documentation or certifications before executing a BAA, depending on the nature and scope of PHI access involved.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-navy">Questions</h2>
            <p>For questions about Nature's Journey&apos;s BAA policy or HIPAA compliance practices, please contact us at compliance@naturesjourneyhealth.com or (888) 509-2745.</p>
          </section>
        </div>
      </SectionShell>
    </section>
