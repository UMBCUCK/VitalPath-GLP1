                  ...
                  <CardContent className="border-t border-navy-100/40 pt-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant={intake.consentGiven ? "success" : "destructive"}>Treatment Consent: {intake.consentGiven ? "Yes" : "No"}</Badge>
                    ...
                    <div className="mt-4 flex gap-3">
                      <Button className="gap-1" onClick={() => approveIntake(intake)}><Check className="h-4 w-4" /> Approve & Prescribe</Button>
